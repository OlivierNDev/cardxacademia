      ...
      {videoTestimonials.length > 0 && (
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            ...
            {/* Video Grid - Instagram format (9:16 aspect ratio) */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {videoTestimonials.map((testimonial) => (
                ...
                >
                  {/* Video Container - Instagram format */}
                  <div className="relative aspect-[9/16] bg-black">
                    {testimonial.videoUrl ? (
                      <>
                        <video
                          src={testimonial.videoUrl}
                          poster={testimonial.thumbnail || testimonial.image}
                          ...
                          ref={(video) => {
                            if (video && playingVideos[testimonial.id]) {
                              video.play().catch(() => {});
                            }
                          }}
                        />
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-black/30 group-hover:bg-black/20 transition-colors">
                          <button
                            ...
                            className="w-16 h-16 bg-white/90 rounded-full flex items-center justify-center hover:bg-white transition-all opacity-0 group-hover:opacity-100"
                          >
      ...
      <section className="py-16 bg-blue-500">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/appointment">
              <button className="bg-white text-blue-500 hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold text-lg transition-all">
                Book an Appointment
              </button>
            </Link>
            <Link to="/contact">
